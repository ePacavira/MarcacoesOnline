        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataInicioPreferida = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataFimPreferida = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HorarioPreferido = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Observacoes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidosMarcacao", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PedidosMarcacao_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubsistemaSaude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActosClinicos_PedidosMarcacao_PedidoMarcacaoId",
                        column: x => x.PedidoMarcacaoId,
                        principalTable: "PedidosMarcacao",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidosMarcacao_UserId",
